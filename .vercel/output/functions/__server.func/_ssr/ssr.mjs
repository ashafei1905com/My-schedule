...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C8V9xyrw.mjs");
...
var manifest = {
	"23bcb4f15984493305fd850cc2968a4622816dd10d9f37268f46fedac3fb776d": {
		functionName: "saveCloudState_createServerFn_handler",
		importer: () => import("./cloud-store-BVEQ4DbI.mjs")
	},
	"8ef62e073bda174789125045dbc00f498671ae5cc97608941293ca9cf574ba40": {
		functionName: "loadCloudState_createServerFn_handler",
		importer: () => import("./cloud-store-BVEQ4DbI.mjs")
	},
	"ac35c86094b78c325ae9ea358e8289742ee13c75ff235d92f3960edeaaa908f7": {
		functionName: "estimateMacrosRemote_createServerFn_handler",
		importer: () => import("./estimate-macros-DveLW7u0.mjs")
	},
	"b7c89a262ff9eb6a8c65f1aa56f14729de78e36a170cd32fb5e570c9fb2f207c": {
		functionName: "askAssistant_createServerFn_handler",
		importer: () => import("./assistant-service-CQpxaTFI.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Cg54asdk.mjs").then((n) => n.t),
