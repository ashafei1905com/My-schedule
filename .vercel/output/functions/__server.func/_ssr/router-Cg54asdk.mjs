...
//#region node_modules/.nitro/vite/services/ssr/assets/router-Cg54asdk.js
...
var styles_default = "/assets/styles-DHg1QZGG.css";
var APP_NAME = "Smart Schedule";
var Route$3 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Protect focus time. Keep meals, prayer, and shutdown on the board."
			}
		],
		links: [
			{
...
var $$splitComponentImporter$1 = () => import("./routes-Bkd55CBF.mjs");
var Route$2 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./login-BeUxNLcG.mjs");
